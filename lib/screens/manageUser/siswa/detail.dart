...
class DetailSiswa extends StatefulWidget {
  DetailSiswa({this.nis,this.id_kelas});
  String nis;
  String id_kelas;
  @override
...
class _DetailSiswaState extends State<DetailSiswa> {
  ...
  void getUser() async {
    final data = await http.get(Uri.parse("${Env.URL_PREFIX}/siswa/${widget.nis}"));
    final response = json.decode(data.body)['data']['siswa'];
    controllernis.text = response['nis'];
    controllernama.text = response['nama'];
    controllerkelamin.text = response['kelamin'];
    controllertmp_lhr.text = response['tmp_lhr'];
    controllertgl_lhr.text = response['tgl_lhr'];
    controlleragama.text = response['agama'];
    controlleralamat.text = response['alamat'];
    controllerkelurahan.text = response['kelurahan'];
    controllerkecamatan.text = response['kecamatan'];
    controllerkabupaten.text = response['kabupaten'];
    controllerkodepos.text = response['kodepos'];
    controllernohp.text = response['nohp'];
    controlleremail.text = response['email'];
    controllernama_ayah.text = response['nama_ayah'];
    controllernama_ibu.text = response['nama_ibu'];
    controlleralamat_ortu.text = response['alamat_ortu'];
    controllerkelurahan_ortu.text = response['kelurahan_ortu'];
    controllerkecamatan_ortu.text = response['kecamatan_ortu'];
    controllerkabupaten_ortu.text = response['kabupaten_ortu'];
    controllerkodepos_ortu.text = response['kodepos_ortu'];
    controllernohp_ortu.text = response['nohp_ortu'];
    controllerpekerjaan_ortu.text = response['pekerjaan_ortu'];
  }
  ...
  void storeUser() async {
    ...
    final response = await http.put(Uri.parse("${Env.URL_PREFIX}/siswa/${widget.nis}"), body: {
