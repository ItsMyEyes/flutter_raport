...
class SiswaOnlyView extends StatefulWidget {
  @override
  _SiswaOnlyViewState createState() => _SiswaOnlyViewState();
}

class _SiswaOnlyViewState extends State<SiswaOnlyView> {
  var _kelas = []; 
  int _current = 0;
  int current = 0;
  String kelas;
                              ...
                              children: <Widget>[
                                ...
                                RaisedButton(
                                    onPressed: () { 
                                      ...
                                      context,
                                      CupertinoPageRoute(
                                        builder: (context) => SiswaIndexOnlyView(id_kelas: kelas),
